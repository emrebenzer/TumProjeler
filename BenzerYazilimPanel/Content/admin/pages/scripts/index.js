        ...
        initDashboardDaterange: function () {
            ...
            $('#dashboard-report-range').daterangepicker({
                    ...
                    ranges: {
                        ...
                        'Son Ay': [moment().subtract('month', 1).startOf('month'), moment().subtract('month', 1).endOf('month')]
                    },
                    ...
                    locale: {
                        ...
                        daysOfWeek: ['Pz', 'Pt', 'Sa', '&#199;r', 'Pr', 'Cu', 'Cm'],
                        monthNames: ['Ocak', '&#350;ubat', 'Mart', 'Nisan', 'May&#305;s', 'Haziran', 'Temmuz', 'Aðustos', 'Eyl&#252;l', 'Ekim', 'Kas&#305;m', 'Aral&#305;k'],
                        firstDay: 1,
                        weekLabel: 'H'
                    }
                },
